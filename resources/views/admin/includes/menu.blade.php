        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li class=""><a class="dropdown-item" href="{{route('all-runing-student-list')}}">All Student List</a></li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('add-slide') }}" class="dropdown-item">Add Slider</a></li>
                                <li><a href="{{ route('manage-slide')}}" class="dropdown-item">Manage Slider</a></li>
                            </ul>
                        </li>
                    <li class="dropdown-submenu">
                        <a class="dropdown-item dropdown-toggle" href="#">Genarel</a>
                        <ul class="dropdown-menu">
                            @if(!isset($header))
