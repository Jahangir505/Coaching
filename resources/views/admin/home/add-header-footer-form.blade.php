            ...
            <div class="col-12 pl-0 pr-0">
                ...
                <form method="POST" action="{{ route('header-and-footer-save') }}" enctype="multipart/form-data" autocomplete="" class="form-inline">
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="title" type="text" class="col-sm-9 form-control @error('owner_name') is-invalid @enderror" name="owner_name" value="{{ old('owner_name') }}" placeholder="Owner Name" required autofocus>
                        @error('owner_name')
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="department" type="text" class="col-sm-9 form-control @error('department') is-invalid @enderror" name="department" value="" placeholder="Owner Department" required value="{{ old('department') }}">
                        @error('department')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="mobile" type="text" class="col-sm-9 form-control @error('mobile') is-invalid @enderror" name="mobile" placeholder="880xxxxxxxx" required value="{{ old('mobile')}}">
                        @error('mobile')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                         @enderror
                    </div>
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="copyright" type="text" class="col-sm-9 form-control @error('copyright') is-invalid @enderror" name="copyright" placeholder="Copyright" required value="{{ old('copyright') }}">
                        @error('copyright')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                         @enderror
                    </div>
