                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('school_name') is-invalid @enderror" name="school_name" value="{{ $school->school_name }}" id="slideTitle" placeholder="Write School name" required>
                                            @error('school_name')
