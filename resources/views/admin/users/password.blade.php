...
<section class="container-fluid">
        <div class="row content regi-form">
            <div class="col-12 pl-0 pr-0">
                ...
                @if(Session::get('error_mess'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong>Error:</strong> {{ Session::get('error_mess') }}
                ...
                <form method="POST" action="{{ route('user-password-update') }}" enctype="multipart/form-data" autocomplete="" class="form-inline">
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="new-password" type="password" class="col-sm-9 form-control @error('new_password') is-invalid @enderror" name="new_password" placeholder="Confirm Password" required>
                        @error('new_password')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                         @enderror
                    </div>
