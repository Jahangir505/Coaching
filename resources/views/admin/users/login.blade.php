        ...
        <div class="col-12 pl-0 pr-0">
            ...
            <form action="{{ route('login') }}" method="post" enctype="multipart/form-data" autocomplete="" class="form-inline">
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <input type="text" name="mobile" value="{{ old('mobile') }}" class="form-control col-sm-9 @error('mobile') is-invalid @enderror" id="email" minlength="8" required autofocus placeholder="Mobile Number" autocomplete="">
                ...
                <div class="form-group col-6 mb-3">
                    ...
                    <a class="col-sm-9 btn btn-primary btn-block" href="{{'/Coaching/public/register'}}">Register</a>
                </div>
